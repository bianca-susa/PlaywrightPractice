...
public class PlaywrightTest {
    ...
    public static void homepageUpdated()
    {
        try (Playwright playwright = Playwright.create()) {
            Browser browser = playwright.chromium().launch(
                    new BrowserType.LaunchOptions().setHeadless(false) );
    ...
    public static void searchUpdated()
    {
        try (Playwright playwright = Playwright.create()) {
            Browser browser = playwright.chromium().launch(
                    new BrowserType.LaunchOptions().setHeadless(false) );
    ...
    public static void newProductsListUpdated()
    {
        try (Playwright playwright = Playwright.create()) {
            Browser browser = playwright.chromium().launch(
                    new BrowserType.LaunchOptions().setHeadless(false) );
    ...
    public static void navigationUpdated()
    {
        try (Playwright playwright = Playwright.create()) {
            Browser browser = playwright.chromium().launch(
                    new BrowserType.LaunchOptions().setHeadless(false) );
    ...
    public static void addProductToCartUpdated()
    {
        try (Playwright playwright = Playwright.create()) {
            Browser browser = playwright.chromium().launch(
                    new BrowserType.LaunchOptions().setHeadless(false) );
            ...
            Locator category = page.locator(".nav-primary> *:first-child");
            category.click();

            Locator subCategory = page.locator(".nav-primary> *:first-child > ul > *:nth-child(3)");
            subCategory.click();

            Locator product = page.locator("ul.products-grid.products-grid--max-4-col.first.last.odd>li:first-of-type");
            product.click();
    ...
    public static void removeProductFromCartUpdated()
    {
        try (Playwright playwright = Playwright.create()) {
            Browser browser = playwright.chromium().launch(
                    new BrowserType.LaunchOptions().setHeadless(false) );
            ...
            Locator product1 = page.locator("ul.products-grid.products-grid--max-4-col.first.last.odd>li:first-of-type");
            product1.click();
            ...
            Locator product2 = page.locator("ul.products-grid.products-grid--max-4-col.first.last.odd>li:nth-child(3)");
            product2.click();
            ...
            Locator removeFromCartButton = page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Remove item")).first();
            removeFromCartButton.click();
...
//        removeProductFromCart();
        ...
        accountUpdated();
        searchUpdated();
        newProductsListUpdated();
        navigationUpdated();
        addProductToCartUpdated();
        removeProductFromCartUpdated();
    }
}
